...
/**
 * This class is use to perform the view of the Schedule window
 * @author Group 11
 *
 */
public class SchedulePage extends JFrame {
	...
	/**
	 * This method implement the actions to create an employee element when the addEmployeeButton is selected
	 * @param evt
	 */
	...
	/**
	 * This method implement the actions to create a Schedule element when the addScheduleButton is selected
	 * @param evt
	 */
	...
	/**
	 * This method implement the actions to create an Schedule registration element when the addRegisterbutton is selected
	 * @param evt
	 */
	...
	private void registerButtonActionPerformed(java.awt.event.ActionEvent evt){
		...
		// error handling for null input on view page
		error = "";
